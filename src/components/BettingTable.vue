<template>
  <div class="betting-table">
    ...
    <div class="betting-table__landscape">
      <div class="table-landscape" style="">
        <div class="numbers">
        ...
        <div class="sectors">
          ...
          <div>
            ...
            <div class="sector num-type" data-sector="10" @click="lld">
              DISPARI
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    clickCell: function(id, price, winning, stakeType) {
      ...
      // console.log("chip----->", this.placedChips);
      localStorage.setItem("placedChips", JSON.stringify(this.placedChips));
    },
    ...
    getLatestChip: function(placeToSearch) {
      ...
      return {
        ...
        isLastPlaced,
        //winning: chips && chips.length ? chips[chips.length - 1].winning : null,
      };
    },
  },
};
...
.betting-table {
  ...
  .controls {
    ...
    .col1 .btn {
      ...
      @media screen and (max-width: 1799px) and (min-width: 1080px) and (orientation : portrait){
        left: 5.6vw;
      }
      @media screen and (max-width: 1080px) and (orientation : portrait) {
        left: 10.5vw;
    ...
    .col2 .btn {
      ...
      @media screen and (max-width: 1799px) and (min-width: 1080px) {
        left: 11.9vw;
      }
      @media screen and (max-width: 1080px) and (orientation : portrait) {
        left: 22.25vw;
...
.table-landscape {
  ...
  .numbers {
    ...
    @media screen and (max-width: 1080px) and (orientation : portrait) {
      // grid-template-rows: repeat(3, 15.5vw);
      grid-template-columns: 10.5vw repeat(4, 1fr) 7.2vw;
    }
